...
### 🎞 배경
 21세기에 이르러 자신을 창작품을 통해 어필하고자하는 욕구와 이를 표현할 수 있는 창구가 많아졌고,
이에 상응하여 이러한 작품을 찾는 소비자도 늘어났습니다. 

 바나나공방은 이 두 집단을 연결할 때, 보다 신뢰성과 현장감을 주고 싶어 기획하게 된 서비스입니다.


### 💡 서비스 특징
누구나 작가가 되어 자신의 작품을 공유할 수 있는 서비스
...
### 📝 기록을 잘하자
  - 스크럼이나 컨설턴트님 회의 등의 기록을 꼼꼼히 하기
  - 오늘 할 일, 오늘 한 일, 해야할 일 등등 매일 기록하기
  - 공부하면서 얻은 지식을 정리해서 공유하기 → 같은 부분에서 삽질 방지
  - 트러블 슈팅을 제대로 관리해서 시간 단축하기

### 📋 명세를 잘하자
  - 스토리보드 → 요구사항 명세 → 기능명세 → api 명세 등
  - 전체적인 흐름을 파악하기 위한 명세 필수
  - README에 기능 명세를 정리하기에는 스웨거 말고 따로 정리하는 것이 좋을 듯