    ...
    <div className={styles["sign-up-container"]}>
      <div className={styles["sign-up-box"]}>
        <div className={styles["inner-box"]}>
          ...
          <div>
            <img src={logo} alt="/" id={styles["logo-img"]}/>
          </div>
          ...
          <div id={styles["div-on-form"]}>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className={styles["label-input"]}>
                <label htmlFor="nickname" className={styles["label-of-form"]}>닉네임</label>
                <div className={styles["input-button"]}>
                  <input name="nickname" placeholder="nickname" {...register('nickname')} id="nickname"
                         className={styles["input-of-form"]}/>
                  <button className={styles["form-btn"]} onClick={onCheckNickname}>중복확인</button>
                </div>
              </div>
              ...
              <div className={styles["label-input"]}>
                <label htmlFor="email" className={styles["label-of-form"]}>이메일</label>
                <div className={styles["input-button"]}>
                  <input id="email" name="email"
                         placeholder="email" {...register('email')} className={styles["input-of-form"]}/>
                  <button onClick={emailVerify} className={styles["form-btn"]}>{verifyMessage}</button>
              ...
              <div className={styles["input-button"]}>
                <input className={styles["input-of-form"]} type="text" placeholder='인증번호를 입력해주세요'
                       id="verifycheck"/>
                <button onClick={VerifyCheck} className={styles["form-btn"]}>인증번호 확인</button>
              </div>
              <div className={styles["hidden-msg"]}>
              ...
              <div className={styles["label-input"]}>
                <label htmlFor="password" className={styles["label-of-form"]}>비밀번호</label>
                <input
                  className={styles["input-of-form"]}
                  type="password"
                  name="password"
              ...
              <div className={styles["label-input"]}>
                <label htmlFor="passwordConfirm" className={styles["label-of-form"]}>비밀번호 확인</label>
                <input
                  className={styles["input-of-form"]}
                  type="password"
