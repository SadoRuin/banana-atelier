                ...
                <div id="div-on-form">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="label-input">
                            ...
                            <label htmlFor="nickname" className="label-of-form">닉네임</label> <br/>

                            <div className="input-button">
                                <input name="nickname" placeholder="nickname" {...register('nickname')} id="nickname"
                                       className="input-of-form"/>
                                <button className="form-btn" onClick={onCheckNickname}>중복확인</button>
                            </div>
                        </div>
                        ...
                        <div className="label-input">
                            <label htmlFor="email" className="label-of-form">이메일</label> <br/>

                            <div className="input-button">
                                <input id="email" name="email"
                                       placeholder="email" {...register('email')} className="input-of-form"/>
                                <button onClick={emailVerify} className="form-btn">{verifyMessage}</button>
                        ...
                        <div className="input-button">
                            <input className="input-of-form" type="text" placeholder='인증번호를 입력해주세요'
                                   id="verifycheck"/>
                            <button onClick={VerifyCheck} className="form-btn">인증번호 확인</button>
                        </div>
                        <div className="hidden-msg">
