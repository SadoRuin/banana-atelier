  ...
  return (
    <div className="login-container">
      <div className="login-box">
        <div>
          <img src={logo} alt="/" id="logo-img" style={{ cursor: "pointer" }} onClick={() => navigate("/")} />
        </div>
        <div id="div-on-form">
          <form onSubmit={onSubmitHandler}>
            ...
            <div className="all-buttons">
              <div className="buttons">
                <button style={{ marginRight: "5px", width: "165px" }} className="form-btn">
                  로그인
                </button>
                <button
              ...
              <div className="buttons">
                <button onClick={handleFindPw} className="form-btn" style={{ width: "340px" }}>
                  비밀번호 재설정
                </button>
              </div>
            </div>
