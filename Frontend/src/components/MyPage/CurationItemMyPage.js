...
function CurationItemMyPage({userNickname, userSeq, curationThumbnail, curationName, curationSeq}) {
  return (
    <div className="art-item__container">

      <Link to={`/${userNickname}/${curationSeq}`} className="art-img__container">
