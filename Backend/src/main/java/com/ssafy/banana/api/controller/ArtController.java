...
//    public ResponseEntity<List<ArtResponseDto>> setMasterpieceList(@RequestBody MasterpieceRequestDto masterpieceRequestDto){
//
//        List<ArtResponseDto> artList = artService.setMasterpieceList(masterpieceRequestDto);
//        return null;
//    }
//
